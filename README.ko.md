...
2. `manifest.json`의 `dependencies`에 직접 추가:
   ...
   ```
3. Unity의 **Package Manager**에서 **Git URL**을 사용하여 추가: `https://github.com/gameframex/com.gameframex.unity.objectstorage.qiniu.git`
...
[Releases](https://github.com/GameFrameX/gameframex/com.gameframex.unity.objectstorage.qiniu/releases)에서 변경 로그를 확인하세요.
## 라이선스
