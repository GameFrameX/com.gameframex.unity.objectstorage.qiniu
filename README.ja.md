...
1. プロジェクトの `manifest.json` の `dependencies` セクションに以下を追加：
   ...
   ```
2. Unity の `Package Manager` で `Git URL` を使用して追加：https://github.com/AlianBlank/com.gameframex.unity.objectstorage.qiniu.git
...
- [GitHub リポジトリ](https://github.com/GameFrameX/com.gameframex.unity.objectstorage.qiniu)
